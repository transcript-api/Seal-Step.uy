...
const ITEMS = [
  {
    ...
    subtitulo: 'Panda blanco y negro',
    imagen: '/images/product-nuevos.png',
    alt: 'Nike Dunk Low blanco y negro estilo panda disponible en Seal Step',
  ...
  },
  {
    ...
    alt: 'Champión Adidas gris con franjas blancas disponible en Seal Step',
    span: '',
  },
  {
    titulo: 'New Balance',
    subtitulo: 'Plateado y azul',
    imagen: '/images/product-deportivos.png',
    alt: 'New Balance plateado y azul marino disponible en Seal Step',
    span: '',
  },
  {
    titulo: 'New Balance',
    subtitulo: 'Total black',
    imagen: '/images/gallery-2.png',
    alt: 'Par de New Balance totalmente negros disponibles en Seal Step',
    span: '',
  },
  {
    titulo: 'Nike Dunk Low',
    subtitulo: 'Gris y blanco',
    imagen: '/images/product-casual.png',
    alt: 'Nike Dunk Low gris y blanco con cordones tipo soga',
    span: '',
  },
  {
    titulo: 'Chancletas Nike',
    subtitulo: 'Crema y gris',
    imagen: '/images/gallery-3.png',
    alt: 'Chancletas Nike acolchadas en crema y gris disponibles en Seal Step',
    span: 'sm:col-span-2',
  },
]
